...
<div id="bg-l1">
	<div class="box-bungkus">
		<h1 class="lvl-jdl" style="float: left;">Level 1</h1>
		...
		<div style="clear: both">
			<div class="bks-img">
				...
				<div style="clear: both;"></div>
				<canvas id="gambar5" class="img-puz" style="display: none"></canvas>
				<canvas id="gambar6" class="img-puz" style="display: none"></canvas>
			</div>
		</div>
		<button id="submit" class="menu" style="margin-top: 80px;font-size: 18px;padding:4px 18px 10px 18px;"><span class="glyphicon glyphicon-ok" style="margin-right: 5px;position: relative;top:2px;"></span>SUBMIT</button>
	</div>
	<img id="gambarori" src="view/image/image20.png" class="img-puz" onload="loadgambar()" style="display: none">
	<img id="gambarori2" src="view/image/benar3.png" class="img-puz" onload="loadgambar2()" style="display: none">
	
	<img id="gambarori3" src="view/image/benar.png" class="img-puz" onload="loadgambar3()" style="display: none">
	<img id="gambarori4" src="view/image/image19.png" class="img-puz" onload="loadgambar4()" style="display: none">

	<img id="gambarbenar2" src="view/image/bener2.png" class="img-puz" onload="loadgambar5()" style="display: none">
	<img id="gambarbenar4" src="view/image/bener4.png" class="img-puz" onload="loadgambar6()" style="display: none">
	<!-- Modal -->
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="text-align: center">
					...
					<img id="gbr-zoom" src="view/image/image.png" onload="loadgambarin()" style="display: none"><br>
					<br>
