...
<div id="bg-l2">
	<div class="box-bungkus" >
		<h1 class="lvl-jdl" style="float: left;">Level 2</h1>
	...
	<img id="gambarori" src="view/image/ikanbenar1.png" class="img-puz" onload="loadgambar()" style="display: none">
	<img id="gambarori2" src="view/image/ikanflip2.png" class="img-puz" onload="loadgambar2()" style="display: none">
	<img id="gambarori3" src="view/image/ikanflip3.png" class="img-puz" onload="loadgambar3()" style="display: none">

	<img id="gambarori4" src="view/image/ikanflip4.png" class="img-puz" onload="loadgambar4()" style="display: none">
	<img id="gambarori5" src="view/image/ikanflip5.png" class="img-puz" onload="loadgambar5()" style="display: none">
	<img id="gambarori6" src="view/image/ikanflip6.png" class="img-puz" onload="loadgambar6()" style="display: none">


	<img id="gambarbenar2" src="view/image/ikanbenar2r.png" class="img-puz" onload="loadgambar7()" style="display: none">
	<img id="gambarbenar3" src="view/image/image40.png" class="img-puz" onload="loadgambar8()" style="display: none">

	<img id="gambarbenar4" src="view/image/ikanbenar4r.png" class="img-puz" onload="loadgambar9()" style="display: none">
	<img id="gambarbenar5" src="view/image/ikanbenar5rpng.png" class="img-puz" onload="loadgambar10()" style="display: none">
	<img id="gambarbenar6" src="view/image/ikanbenar6r.png" class="img-puz" onload="loadgambar11()" style="display: none">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="text-align: center">
					...
					<img id="gbr-zoom" src="view/image/h2.png" onload="loadgambarin()" style="display: none"><br>
					<br>
